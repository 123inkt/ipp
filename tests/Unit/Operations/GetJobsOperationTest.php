...
#[CoversClass(GetJobsOperation::class)]
class GetJobsOperationTest extends TestCase
{
    /**
     * @throws Throwable
     */
    public function testGetJobs(): void
    {
        ...
        $operation           = new GetJobsOperation($server, $client, $parserFactory);
        ...
        $client->expects($this->once())->method('sendRequest')->with(static::callback(static function (IppOperation $operation) {
            static::assertSame(IppOperationEnum::GetJobList, $operation->getOperation());
